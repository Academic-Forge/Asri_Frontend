  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-slate-50">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white md:bg-slate-50/30">
        <div className="w-full max-w-md bg-white rounded-3xl border-0 md:border md:border-slate-100 md:shadow-2xl md:shadow-slate-900/5 p-8 sm:p-10 space-y-8">
          ...
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-sm text-slate-500 font-medium">Silakan masuk menggunakan email terdaftar Anda.</p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5 w-full">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3 text-sm bg-slate-50 border border-slate-200 rounded-xl placeholder-slate-400 focus:outline-none focus:bg-white focus:border-[#4B5320] focus:ring-4 focus:ring-[#4B5320]/10 transition-all duration-200 ${
            ...
            <div className="flex flex-col gap-1.5 w-full">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs font-bold text-[#4B5320] hover:underline cursor-pointer">
                  Lupa sandi?
                </span>
              </div>
              <div className="relative">
          ...
          <button
            type="button"
            className="w-full flex items-center justify-center gap-3 border border-slate-200 rounded-xl py-3 text-sm font-semibold hover:bg-slate-50 transition-colors cursor-pointer hover:border-slate-300"
          >
          ...
          <div className="text-center text-sm text-slate-500 pt-2">
            Belum memiliki akun?{' '}
            <Link to="/register" className="font-extrabold text-[#4B5320] hover:underline">
              Daftar Akun Baru
            </Link>
          </div>
